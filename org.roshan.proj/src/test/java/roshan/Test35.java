...
public class Test35 
{
	public static void main(String args[]) throws Exception
	{
		...
		//search a product and check count of all product in first page to last page using "page no." click in web page
	    ...
	    while(true)
	    {
	    	List<WebElement> l=driver.findElements(By.xpath("//div[contains(@class,'col-12-12')]/descendant::div[@class='_4ddWXP']"));
	    	int pc=l.size();
	    	//System.out.println("Product in page 1: "+l.size());
	    	tpc=tpc+pc;
	    	try
	    	{
	    		driver.findElement(By.linkText(""+pn)).click();
	    		Thread.sleep(3000);
	    		System.out.println("count of products in page "+pn+":"+l.size());
	    		pn++;
	    	}
	    	catch(Exception ex)
	    	{
	    ...
	    int pnc=pn-1;
	    System.out.println("Total product count till page no.: "+pnc);
